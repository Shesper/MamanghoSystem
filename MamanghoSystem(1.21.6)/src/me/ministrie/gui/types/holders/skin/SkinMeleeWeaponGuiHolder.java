...
import me.ministrie.gui.types.skin.SkinMeleeWeaponGui;

public class SkinMeleeWeaponGuiHolder implements ScreenHolder{

	private SkinMeleeWeaponGui gui;
	private boolean previous = true;
	
	public SkinMeleeWeaponGuiHolder(SkinMeleeWeaponGui gui){
		this.gui = gui;
	}
