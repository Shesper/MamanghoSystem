...
import me.ministrie.gui.types.emoticon.EmoticonDetailGui;
import me.ministrie.gui.types.emoticon.EmoticonScreen;
import me.ministrie.thread.ThreadUtils;

public class EmoticonDetailGuiHolder implements ScreenHolder{

	private EmoticonDetailGui gui;
	private boolean previous = true;
	
	public EmoticonDetailGuiHolder(EmoticonDetailGui gui){
		this.gui = gui;
	}
