...
public class WitherArrowEnchant extends CustomEnchantment{

	public static final NamespacedKey key = NamespacedKey.minecraft("wither_arrow");
	...
	public void onTrigger(Player player, EquipmentSlot slot, Object value, int level){
		...
		if(value instanceof EntityShootBowEvent event){
			...
			if(projectile instanceof Arrow){
				...
				arrow.addCustomEffect(new PotionEffect(PotionEffectType.WITHER, Float.valueOf(200.0f*force).intValue(), level-1), true);
